...
export async function loader({ request }) {
	...
	if (isEmpty(stripeSessionId)) {
		return redirect(pages.events.fallPrimer)
	}
...
export default function TheRockArcheryChallengeSuccessPage() {
	...
	return (
		<MainLayout offsetMainContent={false}>
			...
			<PageContent>
				<h2>You're in!</h2>
				<p>Thank you for registering for the The Harvest Fall Primer at Quarry Rock, we look forward to seeing you at the event!</p>
				...
				<p>Finally, if you haven't already done so, please take some time to review <Link to={pages.events.fallPrimerFaq}>the event FAQ page</Link>, as it contains answers to many questions that most people have about the event.</p>
			</PageContent>
		</MainLayout>
	)
}
